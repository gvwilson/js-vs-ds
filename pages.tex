...
We wrap the call in \texttt{document.querySelectorAll} with \texttt{Array.from}
...
\subsection*{What Encoding Is This?}
\begin{enumerate}
\item
...
\subsection*{Removing Text Nodes}
...
\subsection*{A More Robust Table of Contents}
...
\subsection*{Explicitly Creating Nodes}
