...
For example,
\texttt{\textless{}a\ href="selectors.html\#major"\textgreater{}some\ text\textless{}/a\textgreater{}} refers to the \texttt{\#major} element in \texttt{selectors.html},
while \texttt{\textless{}a\ href="selectors.html\#minor"\textgreater{}some\ text\textless{}/a\textgreater{}} refers to the \texttt{\#minor} element.
This is particularly useful \emph{within} pages:
\texttt{\textless{}a\ href="\#major"\textgreater{}jump\textless{}/a\textgreater{}} takes us straight to the \texttt{\#major} element within this page.
